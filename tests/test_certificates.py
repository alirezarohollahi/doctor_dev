...
def test_versioned_certificate_validation_from_paths():
...
def test_versioned_core_dry_run_includes_tls_ref():
    client = TestClient(app)
    ...
    payload = {
        "node_id": node_id,
        "name": f"versioned-tls-core-{suffix}",
        "enabled": True,
        "description": "versioned TLS dry-run test",
        "inbounds": [
            {
        ...
        "advanced_config": {"created_by": "versioned_tls_test"},
    }
    ...
    assert generated["version"] == "doctor-dev.v1"
