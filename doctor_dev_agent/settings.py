...
NODE_NAME = os.getenv("DOCTOR_DEV_NODE_NAME", "local-node-a")
AGENT_HOST = os.getenv("DOCTOR_DEV_AGENT_HOST", "127.0.0.1")
AGENT_PORT = int(os.getenv("DOCTOR_DEV_AGENT_PORT", "9101"))
AGENT_API_KEY = os.getenv("DOCTOR_DEV_AGENT_API_KEY", "local-dev-key-a")
DATA_DIR = Path(os.getenv("DOCTOR_DEV_AGENT_DATA_DIR", "./data")).resolve()
LOG_DIR = Path(os.getenv("DOCTOR_DEV_LOG_DIR", "./logs")).resolve()
CONFIG_DIR = Path(os.getenv("DOCTOR_DEV_AGENT_CONFIG_DIR", "./configs/generated")).resolve()
CERT_DIR = Path(os.getenv("DOCTOR_DEV_AGENT_CERT_DIR", "./certs/agent")).resolve()
